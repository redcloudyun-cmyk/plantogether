...
const en = {
  ...
  demoActivityBadge: 'DEMO', demoActivityTooltip: 'Sample activity seeded for this demo — not a live WebMCP call.',
  demoHistoryBanner: 'Demo history — sample Human + Agent collaboration seeded into this workspace.',
...
const ko: typeof en = {
  ...
  demoActivityBadge: '데모', demoActivityTooltip: '이 데모를 위해 미리 채워진 샘플 활동입니다 — 실시간 WebMCP 호출이 아닙니다.',
  demoHistoryBanner: '데모 기록 — 이 워크스페이스에 미리 채워진 샘플 협업 내역입니다.',
